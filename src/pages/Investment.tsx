  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative">
        ...
        <div className="relative h-40 bg-gradient-to-br from-green-600 to-green-700 flex items-center justify-center">
          <img
          ...
          <div className="relative z-10 text-center px-4">
            ...
            <p className="text-green-100 text-sm">Cùng phát triển giao thông xanh</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 pb-20">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 -mt-6 relative z-10 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Phân loại gói đầu tư</h2>
              ...
              >
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-medium text-gray-900">{category.count} gói</div>
                    <div className="text-xs text-gray-500">Từ {category.minProfit}/ngày</div>
                  </div>
                </div>
                <button
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-lg font-semibold text-gray-800">Gói đầu tư ({filteredPackages.length})</h2>
          ...
          {filteredPackages.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 text-sm">Không tìm thấy gói đầu tư phù hợp</p>
            </div>
          )}
        </div>

        {/* Call to Action */}
        <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-xl shadow-lg p-6 text-white text-center">
          <h2 className="text-lg font-bold mb-2">Bắt đầu đầu tư ngay!</h2>
          <p className="text-green-100 text-sm mb-4">Tham gia cùng hàng nghìn nhà đầu tư thông minh</p>
          <button
